...
def convert_to_chess_move(pipe, input_text):
    ...
    # Strip surrounding whitespace from the generated move
...
# Attach decoder inputs and labels to the input encoding
...
# Select the training and evaluation subsets
train_dataset = dataset.select(range(0, 9))  # Training uses rows 0..8
eval_dataset = dataset.select(range(9, 12))  # Evaluation uses rows 9..11; later rows are unused
